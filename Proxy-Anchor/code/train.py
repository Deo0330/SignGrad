...
# Directory for Log
LOG_DIR = args.LOG_DIR + '/logs_{}/{}_{}_embedding{}_alpha{}_mrg{}_{}_lr{}_batch{}{}__wd{}_seed{}'.format(args.dataset, args.model, args.loss, args.sz_embedding, args.alpha, 
                                                                                            args.mrg, args.optimizer, args.lr, args.sz_batch, args.remark,args.weight_decay,args.seed)
...
elif args.optimizer == 'signadamw':
    opt = SignAdamW(param_groups, lr=float(args.lr), weight_decay = args.weight_decay)
elif args.optimizer == 'diffgrad': 
    opt = diffgrad(param_groups, lr=float(args.lr), weight_decay = args.weight_decay)
elif args.optimizer == 'signgrad': 
    opt = SignGrad(param_groups, lr=float(args.lr), weight_decay = args.weight_decay)
elif args.optimizer == 'adamp': 
    opt = AdamP(param_groups, lr=float(args.lr), weight_decay = args.weight_decay)
elif args.optimizer == 'signadamp': 
    opt = SignAdamP(param_groups, lr=float(args.lr), weight_decay = args.weight_decay)
